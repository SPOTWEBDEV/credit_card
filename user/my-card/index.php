                           ...
                           <script>
                                    $(function() {
                                             ...
                                             function loadUsers(page = 1) {
                                                      ...
                                                      $.ajax({
                                                               url: '../../server/client/api/myCard.php',
                                                               method: 'GET',
                                                               data: {
                                                                        page: page,
                           ...
                           <div class="modal-content border-0">
                                    ...
                                    <div class="modal-body p-4">
                                             ...
                                             if (isset($_POST['generate'])) {
                                                      ...
                                                      $expiry_date = date('m/y', strtotime('+3 years')); // 3 years from today

                                                      // Insert into database
                                                      $insert = mysqli_query($connection, "
                                                                        INSERT INTO cvv_cards 
                                                                        (card_number, cvv, bin, expiry_date, price, status) 
                                                                        VALUES 
                                                                        ('$card_number', '$cvv', '$bin', '$expiry_date', '$price', '$status')
                                                                        ");

                                                      if ($insert) {
                                                               echo "<script>alert('✅ CVV Card generated successfully'); window.location.reload();</script>";
                                                      } else {
                                                               echo "<script>alert('❌ Failed to generate CVV card');</script>";
                                                      }
                                             }
                                             ?>
                                             ...
                                             <div class="modal-body p-4">
                                                      <form method="POST" class="needs-validation" novalidate>
                                                               <div class="mb-3">
                                                                        <label for="price" class="form-label">Number Generated CVV</label>
                                                                        <input type="number" value="2" step="0.01" min="0" name="time" class="form-control" placeholder="Number Generated CVV" required>
                                                               </div>
                                                               <div class="mb-3">
