...
$conneection = mysqli_connect('localhost','root','','credit_card');
...
if(isset($_POST['register'])){
    ...
    if(!empty($email) && !empty($username) && !empty($password)){
        ...
        echo "<script>alert('$hashing')</script>";

        $statement  = "INSERT INTO `user`(username,email,password) VALUES ('$username','$email','$hashing')";

        $query = mysqli_query($conneection)
