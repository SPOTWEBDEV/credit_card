...
<head>
    ...
    <script src="assets/<?php echo $domain ?>assets/assets/libs/simplebar/simplebar.min.js"></script>
    <script src="assets/<?php echo $domain ?>assets/assets/libs/node-waves/waves.min.js"></script>
    <script src="assets/<?php echo $domain ?>assets/assets/libs/feather-icons/feather.min.js"></script>
    <script src="assets/<?php echo $domain ?>assets/assets/js/plugins.js"></script>
