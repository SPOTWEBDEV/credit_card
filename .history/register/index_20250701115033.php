...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sign Up | Invoika - Admin & Dashboard Template</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Premium Multipurpose Admin & Dashboard Template" name="description" />
    <meta content="Themesbrand" name="author" />
    <!-- App favicon -->
    <link rel="shortcut icon" href="<?php echo $domain ?>assets/<?php echo $domain ?>assets/../assetsimages/favicon.ico">

    <!-- Layout config Js -->
    <script src="<?php echo $domain ?>assets/<?php echo $domain ?>assets/<?php echo $domain ?>assets/assets/js/layout.js"></script>
    <!-- Bootstrap Css -->
    <link href="<?php echo $domain ?>assets/<?php echo $domain ?>assets/<?php echo $domain ?>assets/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <!-- Icons Css -->
    <link href="<?php echo $domain ?>assets/<?php echo $domain ?>assets/<?php echo $domain ?>assets/assets/css/icons.min.css" rel="stylesheet" type="text/css" />
    <!-- App Css-->
    <link href="<?php echo $domain ?>assets/<?php echo $domain ?>assets/<?php echo $domain ?>assets/assets/css/app.min.css" rel="stylesheet" type="text/css" />
                                                        ...
                                                        <div class="mt-4">
                                                            <form action="" class="auth-input">
                                                                ...
                                                                <div class="mt-4 text-center">
                                                                    <p class="mb-0">Don't have an account ? <a href="<?php echo $domain ?>assets/auth-signin.php" class="fw-medium text-primary text-decoration-underline"> Signin </a> </p>
                                                                </div>
                                                            </form>
                                                        </div>
    ...
    <!-- JAVASCRIPT -->
    <script src="<?php echo $domain ?>assets/<?php echo $domain ?>assets/<?php echo $domain ?>assets/assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="<?php echo $domain ?>assets/<?php echo $domain ?>assets/<?php echo $domain ?>assets/assets/libs/simplebar/simplebar.min.js"></script>
    <script src="<?php echo $domain ?>assets/<?php echo $domain ?>assets/<?php echo $domain ?>assets/assets/libs/node-waves/waves.min.js"></script>
    <script src="<?php echo $domain ?>assets/<?php echo $domain ?>assets/<?php echo $domain ?>assets/assets/libs/feather-icons/feather.min.js"></script>
    <script src="<?php echo $domain ?>assets/<?php echo $domain ?>assets/<?php echo $domain ?>assets/assets/js/plugins.js"></script>
