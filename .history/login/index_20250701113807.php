<?php 
$domain = "http://localhost/credit_card/server/connection.php";
// This is the domain where your application is hosted. Adjust it as necessary.
?>
...
<head>
    ...
    <!-- password-addon init -->
    <script src="<?php echo $domain ?><?php echo $domain ?><?php echo $domain ?>assets/js/pages/password-addon.init.js"></script>
