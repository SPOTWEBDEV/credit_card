                                                    ...
                                                    <div class="p-lg-5 p-4">
                                                        ...
                                                        <div class="mt-4">
                                                            <form action="https://themesbrand.com/invoika/layouts/index.html" class="auth-input">
                                                                ...
                                                                <div class="mt-4 text-center">
                                                                    <p class="mb-0">Don't have an account ? <a href="<?php echo $domain ?><register>
                                                                    <index></index>.php" class="fw-medium text-primary text-decoration-underline"> Signup now </a> </p>
                                                                </div>
                                                            </form>
                                                        </div>
