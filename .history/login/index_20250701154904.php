...
if(isset($_POST['login'])){
    ...
    if(!empty($username) && !empty($password)){
        ...
        $hashing  = password_verify($password);

        $statement = "SELECT * FROM `users` WHERE `username`='$username' AND `password`='$hashing'";
        ...
        if(mysqli_num_rows($query)){
            ...
            echo "<script>alert('login details don')</script>";
        }
    }
}
                                                        ...
                                                        <div class="mt-4">
                                                            <form method="POST" class="auth-input">
                                                                ...
                                                                <div class="mb-2">
                                                                    ...
                                                                    <div name="password" class="position-relative auth-pass-inputgroup mb-3">
