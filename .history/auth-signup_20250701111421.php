                                                    ...
                                                    <div class="p-lg-5 p-4">
                                                        ...
                                                        <div class="mt-4">
                                                            <form action="https://themesbrand.com/invoika/layouts/index.html" class="auth-input">
                                                                ...
                                                                <div class="mt-4 text-center">
                                                                    <p class="mb-0">Don't have an account ? <a href="auth-signin.html" class="fw-medium text-primary text-decoration-underline"> Signin </a> </p>
                                                                </div>
                                                            </form>
                                                        </div>
...
<!-- Mirrored from themesbrand.com/invoika/layouts/auth-signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Jun 2025 13:09:40 GMT -->
</html>