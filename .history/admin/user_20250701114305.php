...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="<?php echo $domain ?><?php echo $domain ?>assets/images/favicon.ico">

    <!-- Sweet Alert css-->
    <link href="<?php echo $domain ?><?php echo $domain ?>assets/libs/sweetalert2/sweetalert2.min.css" rel="stylesheet" type="text/css" />

    <!-- Layout config Js -->
    <script src="<?php echo $domain ?><?php echo $domain ?>assets/js/layout.js"></script>
    <!-- Bootstrap Css -->
    <link href="<?php echo $domain ?><?php echo $domain ?>assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <!-- Icons Css -->
    <link href="<?php echo $domain ?><?php echo $domain ?>assets/css/icons.min.css" rel="stylesheet" type="text/css" />
    <!-- App Css-->
    <link href="<?php echo $domain ?><?php echo $domain ?>assets/css/app.min.css" rel="stylesheet" type="text/css" />
            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="<?php echo $domain ?><?php echo $domain ?>assets/images/logo-sm.png" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="<?php echo $domain ?><?php echo $domain ?>assets/images/logo-dark.png" alt="" height="21">
                        </span>
                    </a>
                    ...
                    <a href="index.html" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="<?php echo $domain ?><?php echo $domain ?>assets/images/logo-light.png" alt="" height="21">
                        </span>
                    </a>
                </div>
                        ...
                        <div data-simplebar style="max-height: 320px;">
                            ...
                            <div class="notification-list">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                    <div class="d-flex">
                                        <img src="<?php echo $domain ?><?php echo $domain ?>assets/images/users/avatar-2.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="flex-1">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                    <div class="d-flex">
                                        <img src="<?php echo $domain ?><?php echo $domain ?>assets/images/users/avatar-3.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="flex-1">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                    <div class="d-flex">
                                        <img src="<?php echo $domain ?><?php echo $domain ?>assets/images/users/avatar-5.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="flex-1">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-primary rounded-circle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img id="header-lang-img" src="<?php echo $domain ?><?php echo $domain ?>assets/images/flags/us.svg" alt="Header Language" height="20" class="rounded">
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item language py-2" data-lang="en" title="English">
                            <img src="<?php echo $domain ?><?php echo $domain ?>assets/images/flags/us.svg" alt="user-image" class="me-2 rounded" height="18">
                            <span class="align-middle">English</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="sp" title="Spanish">
                            <img src="<?php echo $domain ?><?php echo $domain ?>assets/images/flags/spain.svg" alt="user-image" class="me-2 rounded" height="18">
                            <span class="align-middle">Española</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr" title="German">
                            <img src="<?php echo $domain ?><?php echo $domain ?>assets/images/flags/germany.svg" alt="user-image" class="me-2 rounded" height="18"> <span class="align-middle">Deutsche</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="it" title="Italian">
                            <img src="<?php echo $domain ?><?php echo $domain ?>assets/images/flags/italy.svg" alt="user-image" class="me-2 rounded" height="18">
                            <span class="align-middle">Italiana</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ru" title="Russian">
                            <img src="<?php echo $domain ?><?php echo $domain ?>assets/images/flags/russia.svg" alt="user-image" class="me-2 rounded" height="18">
                            <span class="align-middle">русский</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ch" title="Chinese">
                            <img src="<?php echo $domain ?><?php echo $domain ?>assets/images/flags/china.svg" alt="user-image" class="me-2 rounded" height="18">
                            <span class="align-middle">中国人</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="fr" title="French">
                            <img src="<?php echo $domain ?><?php echo $domain ?>assets/images/flags/french.svg" alt="user-image" class="me-2 rounded" height="18">
                            <span class="align-middle">français</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ar" title="Arabic">
                            <img src="<?php echo $domain ?><?php echo $domain ?>assets/images/flags/ae.svg" alt="user-image" class="me-2 rounded" height="18">
                        ...
                        <div class="dropdown-head rounded-top">
                            ...
                            <div class="pt-2">
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item position-relative">
                                        <div class="d-flex">
                                            <img src="<?php echo $domain ?><?php echo $domain ?>assets/images/users/avatar-8.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                            <div class="flex-1">
                                                <a href="#!" class="stretched-link">
                ...
                <div class="dropdown header-item">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="<?php echo $domain ?><?php echo $domain ?>assets/images/users/avatar-4.jpg" alt="Header Avatar">
...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <div class="help-box text-center">
                            <img src="<?php echo $domain ?><?php echo $domain ?>assets/images/create-invoice.png" class="img-fluid" alt="">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive table-card">
                                        <table class="table table-hover table-nowrap align-middle mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img src="<?php echo $domain ?><?php echo $domain ?>assets/images/users/avatar-1.jpg" alt="" class="avatar-xs rounded-circle me-2">
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo $domain ?><?php echo $domain ?>assets/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle me-2">
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo $domain ?><?php echo $domain ?>assets/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-circle me-2">
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo $domain ?><?php echo $domain ?>assets/images/users/avatar-4.jpg" alt="" class="avatar-xs rounded-circle me-2">
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo $domain ?><?php echo $domain ?>assets/images/users/avatar-5.jpg" alt="" class="avatar-xs rounded-circle me-2">
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo $domain ?><?php echo $domain ?>assets/images/users/avatar-6.jpg" alt="" class="avatar-xs rounded-circle me-2">
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo $domain ?><?php echo $domain ?>assets/images/users/avatar-7.jpg" alt="" class="avatar-xs rounded-circle me-2">
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo $domain ?><?php echo $domain ?>assets/images/users/avatar-8.jpg" alt="" class="avatar-xs rounded-circle me-2">
                                                ...
                                                <tr>
                                                    <td><img src="<?php echo $domain ?><?php echo $domain ?>assets/images/users/avatar-9.jpg" alt="" class="avatar-xs rounded-circle me-2">
                                    ...
                                    <div class="position-relative d-inline-block">
                                        ...
                                        <div class="avatar-lg">
                                            <div class="avatar-title bg-light rounded-circle">
                                                <img src="<?php echo $domain ?><?php echo $domain ?>assets/images/users/user-dummy-img.jpg" id="member-img" class="avatar-md rounded-circle h-auto" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- JAVASCRIPT -->
    <script src="<?php echo $domain ?><?php echo $domain ?>assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="<?php echo $domain ?><?php echo $domain ?>assets/libs/simplebar/simplebar.min.js"></script>
    <script src="<?php echo $domain ?><?php echo $domain ?>assets/libs/node-waves/waves.min.js"></script>
    <script src="<?php echo $domain ?><?php echo $domain ?>assets/libs/feather-icons/feather.min.js"></script>
    <script src="<?php echo $domain ?><?php echo $domain ?>assets/js/plugins.js"></script>

    <!-- Sweet Alerts js -->
    <script src="<?php echo $domain ?><?php echo $domain ?>assets/libs/sweetalert2/sweetalert2.min.js"></script>

    <!-- App js -->
    <script src="<?php echo $domain ?><?php echo $domain ?>assets/js/app.js"></script>
</body>
