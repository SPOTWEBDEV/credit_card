...
<!-- Mirrored from themesbrand.com/<?php echo $sitename ?>/layouts/payments.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Jun 2025 13:09:34 GMT -->
            ...
            <script>
                $(function() {
                    ...
                    function loadUsers(page = 1) {
                        ...
                        $.ajax({
                            url: '../../server/admin/api/getDeposit.php',
                            method: 'GET',
                            data: {
                                page: page,
                ...
                <tr>
                    ...
                    <td> 
                       <a href="./view/?deposit_id=${deposit.deposts_id}"><span style="text-transform:capitalize" class="badge bg-success-subtle text-success p-2">View</span></div></a>
                    </td>
                </tr>
            `);
                                    });
